...
/// <see cref="Phi.Resources.SkillInvocation.TryParse"/> and split the
...
public enum ToolResultState
{
    ...
    Completed,
    /// <summary>The harness reported <see cref="Phi.Agent.ToolResult.IsError"/>.</summary>
    Failed,
}
...
/// (see <see cref="Phi.Status.SessionStatusRouter"/>); the projector
/// just appends every <see cref="Phi.Agent.HarnessErrorEvent"/> it sees and
