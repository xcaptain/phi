...
public class SessionNavigatorTests : IDisposable
{
    ...
    public SessionNavigatorTests()
    {
        ...
        _factory = new SessionFactory(_resolver);
    }
    ...
    public async Task Constructor_WithNullResumeId_BuildsFreshUnpersistedSession()
    {
        ...
        var session = (Session)navigator.Current;
    ...
    {
        var stored = Session.Create(_cwd, "record-model");
    ...
    public async Task Resume_SwapsSessionAndDisposesPrevious()
    {
        ...
        var current = (Session)navigator.Current;
    ...
    public async Task NavigateWhileRunning_CancelsRunThenSwitches()
    {
        ...
        var sessionA = (Session)navigator.Current;
    ...
    public async Task NavigateToNew_StartsFreshEmptyUnpersistedSession()
    {
        ...
        var fresh = (Session)navigator.Current;
    ...
    {
        var navigator = CreateNavigator();
        var originalId = ((Session)navigator.Current).Id;
