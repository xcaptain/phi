...
public class SessionTests : IDisposable
{
    ...
    {
        var session = Session.GetOrCreateDefault(_cwd, "test-model");
    ...
    {
        var first = Session.GetOrCreateDefault(_cwd, "test-model");
        var second = Session.GetOrCreateDefault(_cwd, "test-model");
    ...
    {
        var a = Session.Create(_cwd, "m");
        var b = Session.Create(_cwd, "m");
    ...
    public async Task AppendMessage_PersistsAndLoadsBack()
    {
        ...
        var reopened = Session.Resume(session.Id, _cwd);
    ...
    {
        await Assert.That(() => Session.Resume("nope", _cwd))
