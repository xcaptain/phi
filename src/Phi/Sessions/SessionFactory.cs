...
/// <summary>
/// Creates and resumes <see cref="Session"/> instances. Both entry
...
public sealed class SessionFactory
{
    ...
    public SessionFactory(IProviderResolver resolver)
    {
    ...
    /// </summary>
    public Session Resume(SessionConfig config, string id)
    {
        ArgumentNullException.ThrowIfNull(config);
        var session = Session.Resume(id, config.Cwd);
