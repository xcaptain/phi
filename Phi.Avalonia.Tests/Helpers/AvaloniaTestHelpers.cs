...
/// <summary>
/// Helpers for poking at <see cref="Phi.Avalonia.Components.CollapsibleSection"/>
...
internal static class AvaloniaTestHelpers
{
    ...
    /// </summary>
    public static Border FindHeaderArea(Phi.Avalonia.Components.CollapsibleSection section)
    {
    ...
    /// </summary>
    public static ContentControl FindBodyHost(Phi.Avalonia.Components.CollapsibleSection section)
    {
        var root = (StackPanel)section.Content!;
